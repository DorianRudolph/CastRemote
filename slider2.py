...
<MDSlider2>
    ...
    MDCard:
        ...
        size: hint_label.texture_size[0] + dp(10), hint_label.texture_size[1] + dp(10)
        pos:
            (slider.value_pos[0] - hint_box.width/2 + dp(6), slider.center_y - hint_box.height / 2 + dp(30)) \
            if slider.orientation == "horizontal" \
        ...
        MDLabel2:
            id: hint_label
            text: slider.hint_text or str(int(slider.value))
            font_style: "Caption"
...
class MDSlider2(ThemableBehavior, Slider):
